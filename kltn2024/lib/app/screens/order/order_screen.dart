...
class _OrderState extends State<Order> {
  ...
  confirmOrderButtonPressed(String address) async {
    ...
    String body = 'Đơn đặt hàng của bạn đã được xác nhận!\n\n';
  ...
  Future<void> sendEmail(String userEmail, String subject, String body) async {
    String username = 'buihieucp10vt9@gmail.com';
    String password = 'vfqd aoum fpip bghd';
    ...
    return StreamBuilder(
      ...
      builder: (context, AsyncSnapshot snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          return const Center(child: Text('Chưa có đơn hàng nào được thêm'));
        } else {
